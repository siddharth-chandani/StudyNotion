  ...
  return (
    <div
      className={`max-w-[300px] w-[360px] lg:w-[30%] ${
        currentCard === cardData?.heading
          ? "bg-white dark-cursor shadow-[12px_12px_0_0] shadow-yellow-50"
          : "bg-richblack-800"
    ...
    >
      <div className="border-b-[2px] border-richblack-400 border-dashed h-[80%] p-6 flex flex-col gap-3">
        <div
          className={` ${
            currentCard === cardData?.heading && "text-richblack-800 dark-cursor"
      ...
      <div
        className={`flex justify-between  transition-all ease-linear ${
          currentCard === cardData?.heading
            ? "text-blue-300 hover:text-blue-500 dark-cursor"
