...
function FAQ() {
    ...
    return (
        <div className='bg-pure-greys-5 text-black dark-cursor'>
            <section className="mx-auto p-8 transition duration-500 dark-cursor">
                <h2 className="text-3xl mb-10 font-bold text-center dark-cursor">
